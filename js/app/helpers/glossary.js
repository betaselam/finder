        ...
        var Glossary = {
            ...
            popoverContextualHelp: function (elementId, data) {
                ...
                if (elementId.indexOf("In-Network-Out-of-Pocket-Limit") > -1) {
                    popoverContents = "<p>The maximum amount you will have to pay for in-network covered services in a year. Generally this includes the deductible, coinsurance, and copayments </p>" +
                    ...
                    $('.contextualHelp[data-name="' + elementId + '"]').popover({
                        ...
                        e.preventDefault();
                        clickedAway = ($('.popover').length > 0 && g_itemclicked === elementId) ? true : false;
                        ($('.popover').length > 0 && g_itemclicked === elementId) ? $('.contextualHelp').popover('hide') : $(this).popover('show');
                        (g_itemclicked !== elementId) ? $(".contextualHelp[data-name=" + g_itemclicked + "]").popover('hide') : "";
                        g_itemclicked = elementId;
                        isVisible = true;
                    }).blur(function (e) {
                        e.preventDefault();
                        $(this).popover('hide');
                    ...
                    ($('#' + elementId).length > 0) ? $('#' + elementId).html(popoverContents) : '';

                } else if (elementId.indexOf("Provider-Type-PPO") > -1) {
                    popoverContents = "<p>A type of health plan that contracts with medical providers, such as hospitals and doctors, to create a network of participating providers. You pay less if you use providers that belong to the plan's network.</p>" +
                    ...
                    popoverContents = "<p>Also known as \"Fee-for-Service\" plans, indemnity plans allow you to choose your providers from among any provider that agrees to treat you.</p>" +
                    ...
                    popoverContents = "<p>A type of plan in which you pay less if you use doctors, hospitals, and other health care providers that belong to the plan's network. POS plans may require you to get a referral from your primary care doctor in order to see a specialist.</p>" +
                    ...
                    popoverContents = "<p>Similar to an HMO, a managed care plan under which non-emergency services are covered only if you go to doctors, specialists, or hospitals in the plan's network.</p>" +
                    ...
                    popoverContents = "<p>A copay is the flat dollar amount that a patient must pay when visiting an in-network primary care physician. The range of primary care physician office visit copays shown represents the different options available for the particular plans available under that product.</p>" +
                    ...
                    popoverContents = "<p>Co-insurance is a cost-sharing agreement where employees pay a certain percentage of medical costs for a certain medical expense after their deductible has been met. The range of co-insurance percentages shown represents the different options available for the particular plans available under that product.</p>" +
                    ...
                    popoverContents = "<p>The estimated average cost per enrollee per month. The average cost per enrollee may be lower or higher than the actual premium paid because this figure represents the total written premium for this product divided by total enrollment. The actual cost will vary depending on several factors, including: the specific plan chosen within this product; the demographics of the group; the cost-sharing options chosen such as deductible and out-of-pocket maximum levels; and whether the employee is purchasing the plan for self-only or as family coverage.</p>";
                    $('.contextualHelp[data-name="' + elementId + '"]').popover({
                        autoReposition: true,
                    ...
                    popoverContents = "<p>There are generally five types of health care plans that are available to choose from. These include:</p>" +
                    ...
                    popoverContents = "<p>A benefit for which the insurer pays either through first-dollar coverage or in combination with cost-sharing (such as a copay, co-insurance, or deductible).</p>";
                    ...
                    popoverContents = "<p>A benefit that is not covered by the particular product offered which requires the subscriber to pay the full cost of the services out-of-pocket.</p>";
                    ...
                    popoverContents = "<p>A benefit that is restricted in some way. For example, it may require a waiting period, have a separate deductible, have a benefit cap, or be limited to certain circumstances (for example, if acupuncture is covered only as an alternative to anesthesia).</p>";
                    ...
                    popoverContents = "<p>A benefit that is available as an option at additional cost. This extra coverage is commonly referred to as an “optional rider.”.</p>";
                    ...
                    popoverContents = "<p>The starting price quoted by the insurance company for the monthly premium you would pay for health insurance, whether you use medical services or not. This estimate is based on the information that you provided earlier: zip code, sex, age, and the number of people in your family.</p>" +
                    ...
                    popoverContents = "<p>The amount you must pay each year for covered services before your insurer begins to pay. Insurers apply and structure deductibles differently. For example, under one plan, a single deductible might apply to all covered services while another plan might have separate deductibles for different covered services such as prescription drug coverage.</p>" +
                    ...
                    popoverContents = "<p>This is the percentage of applications submitted for an insurance policy over the time period reported and were denied.</p>" +
                    ...
                    popoverContents = "<p>Actual cost of coverage may be higher than this estimated base rate. Insurers can charge more than the estimate you see here, based on your health status or other factors.</p>" +
                    ...
                    popoverContents = "<p class='popover-bluebar'>What you will pay will vary as you move from generic to brand to non-formulary drugs. There may also be different utilization management rules such as step therapies and prior-authorization as the prescriptions become more expensive.</p>" +
                    ...
                    popoverContents = "<p>A generic drug is a medicine that is the same as a brand-name drug. It has the same dosage, strength, quality, performance, safety, and intended use.</p>";
                    ...
                    popoverContents = "<p>Also known as \"Tier 3\" drugs, non-formulary drugs can be prescribed and dispensed, but at a greater cost to you.</p>" +
                    ...
                    popoverContents = "<p>Brand name drugs are medicines that are produced and supplied by a single company. They are patent protected and marketed under the company's brand name.</p>";
                    ...
                    popoverContents = "<p>A formulary is a list of drugs that your insurance plan covers. It may include how much you pay for each drug (If the plan uses \"tiers,\" the formulary may list which drugs are in which tiers). Formularies may include both generic drugs and brand-name drugs.</p>";
